...
return (
<>
<div className="w-[492px] mr-[42px] rounded shadow-lg flex flex-row h-[565px] border border-green-500">
...
<div className="px-5 py-4 border  border-yellow-600 flex flex-col">
